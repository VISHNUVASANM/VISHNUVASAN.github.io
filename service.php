...
<body>
    <header>
        ...
        <ul class="navigation">
            ...
            <li> <a href="project.php#about">About us</a></li>
    ...
    <section class="banner-s" id="banner">
    <div class="content">
        <h2 class="anim"><span>Simply Awesome</span> ! <br> Alpha <span>.</span></h2>
        
        <a href="#service1" class="btn anim">View more</a>
    </div>
  </section>  
  </div>
    ...
    <section class="service1" id="service1">
        <div class="title">
            <h2>Our services</h2>
            <p>The ability to apply AI, automation, blockchain, the Internet of Things, 5G, cloud, and quantum computing at scale has made the promise of Cognitive Enterprises real.
            </p>
        </div>
        <div class="content1">
            <div class="servicesBx">
                <img src="sicon1.png" >
                <h2>Web Design</h2>
                <p>We will build your website and fullfill all your needs. SEO optimization is Included.
                </p>
            </div>
            <div class="servicesBx">
                <img src="sicon2.png" >
                <h2>Devolopements</h2>
                <p>We will build and develope your website and fullfill all your needs. SEO optimization is Included.
                </p>
            </div>
            <div class="servicesBx">
                <img src="sicon3.png" >
                <h2>Android Apps</h2>
                <p>We will optimize the existing website or mobile application in SEO and performance.
                </p>
            </div>
            <div class="servicesBx">
                <img src="sicon4.png" >
                <h2>Digital Marketing</h2>
                <p>We will ensure that your ideas is well known in attempt to gather user base and expand your ideas.
                </p>
            </div>
            <div class="servicesBx">
                <img src="sicon5.png" >
                <h2>Consultation</h2>
                <p>We offers free consultation about your ideas and offer your best approach to realize it.
            ...
            <div class="servicesBx">
                <img src="sicon6.png" >
                <h2>Event Hosting</h2>
                <p>We will take care of event hosting and management process for your public. you just need to appear on event,as a host.
                </p>
            </div>
        </div>
    </section>
