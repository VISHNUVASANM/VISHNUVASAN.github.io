...
<body>
    ...
    <section class="banner-c" id="banner">
    <div class="content anim">
        <h2><span>A Personal Touch</span><br>with Alpha <span>.</span> </h2>
                ...
                <div class="contactInfoBx">
                    ...
                    <div class="box">
                        <div class="icon">
                            ...
                            <div class="text">
                                <h3>Email</h3>
                                <p>alpha3213i0@temporary-mail.net</p>
                            </div>
                    </div>
                </div>
            </div>
            <div class="formBx">
                <form action="https://formsubmit.co/18a99a0fc7160567670cb3e38dae5f64" method="POST">
                    <h3>Message Us</h3>
                    <input type="text" name=" UserName" id="UserName" placeholder="Your name" required>
                    <input type="email" name="Email Id" id="Email Id" placeholder="Email" required>
                    <input type="text" name="Phone number" id="Phone number" placeholder="Phone no." required>
