...
<header>
    ...
    <section class="banner-p" id="banner">
    <div class="content">
        <h2 class="anim">Predict the <span>Future</span> <br>with Alpha<span>.</span> </h2>
        
        <a href="#work" class="btn anim">Explore</a>
    </div>
  </section>  
  </div>
    ...
    <section class="work" id="work">
        <div class="title">
            <h2>Recent works</h2>
            <p> The<b> Alpha <span>.</span></b> Space Tech project recently released two new open source projects that solve common problems.
            </p>
        </div>
        <div class="content1">
            <div class="workBx">
